...
function App() {
  ...
  // Simulate loading of assets and initial data + Setup Firebase
  useEffect(() => {
    const loadAssets = async () => {
      try {
        // Create an array of promises for all assets to preload
        const assetPromises = [
          ...
          // Add artificial delay to show the loader (remove in production)
        ...
        // Hide loader even if there's an error to avoid blocking the UI
        setIsLoading(false);
      }
    };
